...
class App extends Component {
  ...
  state={cards: [
    {id:0, foodName: "Piatto1", prezzo: 1.99, img: img1,quantità: 0},
    {id:1, foodName: "Piatto2", prezzo: 2.99, img: img2,quantità: 0},
    {id:2, foodName: "Piatto3", prezzo: 3.99, img: img3,quantità: 0},
    {id:3, foodName: "Piatto4", prezzo: 4.99, img: img2,quantità: 0},
    {id:4, foodName: "Piatto5", prezzo: 5.99, img: img1,quantità: 0},
    {id:5, foodName: "Piatto6", prezzo: 6.99, img: img2,quantità: 0},
    {id:6, foodName: "Piatto7", prezzo: 3.99, img: img1,quantità: 0},
    {id:7, foodName: "Piatto8", prezzo: 4.99, img: img3,quantità: 0},
    {id:8, foodName: "Piatto9", prezzo: 5.99, img: img2,quantità: 0},
    {id:9, foodName: "Piatto10", prezzo: 6.99, img: img1,quantità: 0},
    {id:10, foodName: "Piatto11", prezzo: 5.99, img: img3,quantità: 0},
    {id:11, foodName: "Piatto12", prezzo: 6.99, img: img2,quantità: 0}
  ]}
...
//aggiorno stato della lista non by id ma passano tutto l'ogg, lo facciamo per vedere un modo alternativo
//di implementare questa funzione rispetto a handleDelete
  handleIncrement = card =>{
    const cards =[...this.state.cards];
    //trovo id pietanza di cui incrementare la quantità
